...
@genType
and entities = {
    @as("BinState") binState: entityStoreOperations<Entities.BinState.t>,
    @as("Market") market: entityStoreOperations<Entities.Market.t>,
    @as("MarketDistribution") marketDistribution: entityStoreOperations<Entities.MarketDistribution.t>,
    @as("MarketStats") marketStats: entityStoreOperations<Entities.MarketStats.t>,
    @as("Trade") trade: entityStoreOperations<Entities.Trade.t>,
    @as("UserPosition") userPosition: entityStoreOperations<Entities.UserPosition.t>,
    @as("UserStats") userStats: entityStoreOperations<Entities.UserStats.t>,
  }
  ...
  let entities = {
      binState: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.BinState)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.BinState.t,
            >
      ...
      marketDistribution: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketDistribution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketDistribution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      marketStats: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      trade: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Trade)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Trade.t,
            >
      ...
      userStats: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UserStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UserStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
